...
export const initJourneyWithFrames = async (journeyId: string, productImage: string) => {
  ...
  // First Frame
  const ProductFrameJson = GetProductFrame(journeyId, Frames[0], Frames[1], Frames[2], productImage);
  ...
  // Second Frame
  const DescriptionFrameJson = GetDescriptionFrame(journeyId, Frames[1], Frames[2]);
  ...
  // Third Frame
  const emailFrameJson = GetEmailFrame(journeyId, Frames[2], Frames[3], productImage);
  ...
  // Fourth Frame
  const BuyFrameJson = GetBuyFrame(journeyId, Frames[3], Frames[4]);
  ...
  //Fifth Frame
  const SuccessFrameJson = GetSuccessFrame(journeyId, Frames[4]);
